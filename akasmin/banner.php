<?php
    ...
    if(isset($_POST['submit']))
    {
      ...
      $imgPath = "http://139.59.40.169/banner/"."img".date("YmdGis").basename( $_FILES['image']['name']);
      if(move_uploaded_file($_FILES['image']['tmp_name'], $target_path)){
          $con = mysqli_connect(DB_HOST, DB_USER, DB_PASS, DB_NAME);
          $res = mysqli_query($con,"insert into banners (img) values ('$imgPath') ");
          mysqli_close($con);
          if($res)
          {
      ...
      {
          $con = mysqli_connect(DB_HOST, DB_USER, DB_PASS, DB_NAME);
          $res = mysqli_query($con,"delete from banners where bid = '".$_GET['delete']."' ");
          mysqli_close($con);
          if($res)
              echo "<script>alert('Successfully Deleted!');window.open('banner.php','_parent');</script>";
          else
              echo "<script>alert('There was an error uploading the file, please try again!');window.open('banner.php','_parent');</script>";
      }
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                      ...
                      <li> <a class="waves-effect waves-dark active" href="banner.php" aria-expanded="false"><i class="mdi mdi-calendar-multiple"></i><span class="hide-menu">Banner Manager</span></a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                          <div class='card-body'>
                            <div class="d-flex">
                                <h4 class="card-title"><span class="lstick"></span>Upload Banner</h4>
                            </div>
                            <form action="banner.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <input class="btn btn-success" style="width:100%" type="submit" value="Upload Image" name="submit">
                                </div>
                            </form>
                          </div>
                        </div>
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                          <div class="card-body">
                            <div class="d-flex">
                                <h4 class="card-title"><span class="lstick"></span>All Banners </h4>
                            </div>
                          </div>
                        </div>
                      	<?php
                              $con = mysqli_connect(DB_HOST,DB_USER,DB_PASS,DB_NAME);
                              $res = mysqli_query($con, "select bid, img from banners");
                              mysqli_close($con);
                              ...
                              ?>
                                  <div class='card'>
                                      <div class='card-body'>
                                          <center><p><img style='width: 100%;' src = "<?php echo $row["img"]; ?>"/></p></center>
                                          Delete Image : <span class="pull-right"><a href="?delete=<?php echo $row["bid"];?>">Yes</a></span>
                                      </div>
                                  </div>
                              <?php
                              }
