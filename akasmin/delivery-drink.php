...
<head>
    ...
    <title>Drink Delivery - FruizHUB</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                      ...
                      <li> <a class="waves-effect waves-dark active" href="delivery-drink.php" aria-expanded="false"><i class="mdi mdi-truck"></i><span class="hide-menu">Drink Delivery</span></a></li>
                        ...
                        <div class="card">
                          <div class='card-body'>
                            ...
                            <div class="message-box contact-box">
                                ...
                                <?php
                                    $res = executeQuery("select name, phone, tid from transactions where tstatus = 'processing'");
                        ...
                        <div class="card">
                            <div class="card-body">
                              <?php
                                  ...
                                  {
                                    $tid = $_GET['tod_tid'];
                                    $data = mysqli_fetch_array(executeQuery("select name, phone, address, dtime, tmode from transactions where tid=  $tid"));
                                    echo '<div class="d-flex">
                                            <h4 class="card-title"><span class="lstick"></span>Drink Delivery Details</h4>
                                        </div>';
                                        echo "<b>Name: </b>".$data[0]."<br/>
                                              <b>Phone: </b>".$data[1]."<br/>
                                              <b>Address: </b>".$data[2]."<br/>
                                              <b>Delivery Time: </b>".$data[3]."<br/>
                                              <b>Payment Mode: </b>".$data[4]."<br/>";
                                    ?>
